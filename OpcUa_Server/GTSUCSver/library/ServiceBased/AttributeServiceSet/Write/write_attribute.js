...
function GenerateScalarValue( value, dataType, offset ) {
    ...
    switch( dataType ) {
        ...
        case Identifier.Duration: value.setDouble( 3.1415926536 + offset ); break;
        ...
        case Identifier.NodeId:  value.setNodeId( new UaNodeId() ); break;
        case Identifier.Number:  value.setUInt16( 60001 + offset ); break;
