...
function TranslateBrowsePathsToNodeIdsHelperLegacy()
{
    ...
    this.executeAndValidate = function( session )
    {
        ...
        var BrowsePaths = [];
        for( var i = 0; i < request.BrowsePaths.length; i++ ) BrowsePaths[i] = request.BrowsePaths[i].clone();
        TranslateBrowsePathsToNodeIdsHelper.Execute( { UaBrowsePaths: BrowsePaths, ReturnDiagnostics: request.RequestHeader.ReturnDiagnostics, SkipValidation: true } );
        uaStatus = TranslateBrowsePathsToNodeIdsHelper.UaStatus;
        request = TranslateBrowsePathsToNodeIdsHelper.Request;
        this.response = TranslateBrowsePathsToNodeIdsHelper.Response;
