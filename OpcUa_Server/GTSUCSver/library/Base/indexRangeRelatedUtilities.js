...
// Function returns the MonitoredItem object added by the dimensions attribute and an array of all values
function getMatrixValues( args ) {
    if ( !isDefined( args.Item ) ) {
        addError( "getMatrixValues: args.Item not specified." );
        return ( false );
    }
    if ( isDefined( args.Item.length ) ) args.Item = args.Item[0];
    if ( args.Item.length > 1 ) {
        addError( "getMatrixValues: args.Item need to be a single MonitoredItem object." );
        return ( false );
    }
    if ( !isDefined( args.Item.Value ) ) {
        addError( "getMatrixValues: args.Item.Value not defined." );
        return ( false );
    }
    args.Item.Dimensions = new UaInt32s();

    switch ( args.Item.Value.Value.DataType ) {
        case BuiltInType.Boolean:
            args.Item.MatrixValues = new UaBooleans();
            args.Item.Value.Value.toBooleanMatrix( args.Item.Dimensions, args.Item.MatrixValues );
            break;
        case BuiltInType.Byte:
            args.Item.MatrixValues = new UaBytes();
            args.Item.Value.Value.toByteMatrix( args.Item.Dimensions, args.Item.MatrixValues );
            break;
        case BuiltInType.ByteString:
            args.Item.MatrixValues = new UaByteStrings();
            args.Item.Value.Value.toByteStringMatrix( args.Item.Dimensions, args.Item.MatrixValues );
            break;
        case BuiltInType.DateTime:
            args.Item.MatrixValues = new UaDateTimes();
            args.Item.Value.Value.toDateTimeMatrix( args.Item.Dimensions, args.Item.MatrixValues );
            break;
        case BuiltInType.Double:
            args.Item.MatrixValues = new UaDoubles();
            args.Item.Value.Value.toDoubleMatrix( args.Item.Dimensions, args.Item.MatrixValues );
            break;
        case BuiltInType.Float:
            args.Item.MatrixValues = new UaFloats();
            args.Item.Value.Value.toFloatMatrix( args.Item.Dimensions, args.Item.MatrixValues );
            break;
        case BuiltInType.Guid:
            args.Item.MatrixValues = new UaGuids();
            args.Item.Value.Value.toGuidMatrix( args.Item.Dimensions, args.Item.MatrixValues );
            break;
        case BuiltInType.Int16:
            args.Item.MatrixValues = new UaInt16s();
            args.Item.Value.Value.toInt16Matrix( args.Item.Dimensions, args.Item.MatrixValues );
            break;
        case BuiltInType.Int32:
            args.Item.MatrixValues = new UaInt32s();
            args.Item.Value.Value.toInt32Matrix( args.Item.Dimensions, args.Item.MatrixValues );
            break;
        case BuiltInType.Int64:
            args.Item.MatrixValues = new UaInt64s();
            args.Item.Value.Value.toInt64Matrix( args.Item.Dimensions, args.Item.MatrixValues );
            break;
        case BuiltInType.SByte:
            args.Item.MatrixValues = new UaSBytes();
            args.Item.Value.Value.toSByteMatrix( args.Item.Dimensions, args.Item.MatrixValues );
            break;
        case BuiltInType.String:
            args.Item.MatrixValues = new UaStrings();
            args.Item.Value.Value.toStringMatrix( args.Item.Dimensions, args.Item.MatrixValues );
            break;
        case BuiltInType.UInt16:
            args.Item.MatrixValues = new UaUInt16s();
            args.Item.Value.Value.toUInt16Matrix( args.Item.Dimensions, args.Item.MatrixValues );
            break;
        case BuiltInType.UInt32:
            args.Item.MatrixValues = new UaUInt32s();
            args.Item.Value.Value.toUInt32Matrix( args.Item.Dimensions, args.Item.MatrixValues );
            break;
        case BuiltInType.UInt64:
            args.Item.MatrixValues = new UaUInt64s();
            args.Item.Value.Value.toUInt64Matrix( args.Item.Dimensions, args.Item.MatrixValues );
            break;
        case BuiltInType.XmlElement:
            args.Item.MatrixValues = new UaXmlElements();
            args.Item.Value.Value.toXmlElementMatrix( args.Item.Dimensions, args.Item.MatrixValues );
            break;
        case BuiltInType.Variant:
            args.Item.MatrixValues = new UaVariants();
            args.Item.Value.Value.toVariantMatrix( args.Item.Dimensions, args.Item.MatrixValues );
            break;
        case BuiltInType.LocalizedText:
            args.Item.MatrixValues = new UaLocalizedTexts();
            args.Item.Value.Value.toLocalizedTextMatrix( args.Item.Dimensions, args.Item.MatrixValues );
            break;
        case BuiltInType.QualifiedName:
            args.Item.MatrixValues = new UaQualifiedNames();
            args.Item.Value.Value.toQualifiedNameMatrix( args.Item.Dimensions, args.Item.MatrixValues );
            break;
        default:
            addError( "getMatrixValues: Unknown DataType." );
            break;
    }
...
function setMatrixValues( args ) {
    ...
    if ( !isDefined( args.Item.Dimensions ) ) {
        addError( "getMatrixValues: args.Item.Dimensions not defined." );
        return ( false );
    }
    if ( !isDefined( args.Item.MatrixValues ) ) {
        addError( "getMatrixValues: args.Item.MatrixValues not defined." );
        return ( false );
    }

    switch ( args.Item.Value.Value.DataType ) {
        case BuiltInType.Boolean:
            args.Item.Value.Value.setBooleanMatrix( args.Item.Dimensions, args.Item.MatrixValues );
            break;
        case BuiltInType.Byte:
            args.Item.Value.Value.setByteMatrix( args.Item.Dimensions, args.Item.MatrixValues );
            break;
        case BuiltInType.ByteString:
            args.Item.Value.Value.setByteStringMatrix( args.Item.Dimensions, args.Item.MatrixValues );
            break;
        case BuiltInType.DateTime:
            args.Item.Value.Value.setDateTimeMatrix( args.Item.Dimensions, args.Item.MatrixValues );
            break;
        case BuiltInType.Double:
            args.Item.Value.Value.setDoubleMatrix( args.Item.Dimensions, args.Item.MatrixValues );
            break;
        case BuiltInType.Float:
            args.Item.Value.Value.setFloatMatrix( args.Item.Dimensions, args.Item.MatrixValues );
            break;
        case BuiltInType.Guid:
            args.Item.Value.Value.setGuidMatrix( args.Item.Dimensions, args.Item.MatrixValues );
            break;
        case BuiltInType.Int16:
            args.Item.Value.Value.setInt16Matrix( args.Item.Dimensions, args.Item.MatrixValues );
            break;
        case BuiltInType.Int32:
            args.Item.Value.Value.setInt32Matrix( args.Item.Dimensions, args.Item.MatrixValues );
            break;
        case BuiltInType.Int64:
            args.Item.Value.Value.setInt64Matrix( args.Item.Dimensions, args.Item.MatrixValues );
            break;
        case BuiltInType.SByte:
            args.Item.Value.Value.setSByteMatrix( args.Item.Dimensions, args.Item.MatrixValues );
            break;
        case BuiltInType.String:
            args.Item.Value.Value.setStringMatrix( args.Item.Dimensions, args.Item.MatrixValues );
            break;
        case BuiltInType.UInt16:
            args.Item.Value.Value.setUInt16Matrix( args.Item.Dimensions, args.Item.MatrixValues );
            break;
        case BuiltInType.UInt32:
            args.Item.Value.Value.setUInt32Matrix( args.Item.Dimensions, args.Item.MatrixValues );
            break;
        case BuiltInType.UInt64:
            args.Item.Value.Value.setUInt64Matrix( args.Item.Dimensions, args.Item.MatrixValues );
            break;
        case BuiltInType.XmlElement:
            args.Item.Value.Value.setXmlElementMatrix( args.Item.Dimensions, args.Item.MatrixValues );
            break;
        case BuiltInType.Variant:
            args.Item.Value.Value.setVariantMatrix( args.Item.Dimensions, args.Item.MatrixValues );
            break;
        case BuiltInType.LocalizedText:
            args.Item.Value.Value.setLocalizedTextMatrix( args.Item.Dimensions, args.Item.MatrixValues );
            break;
        case BuiltInType.QualifiedName:
            args.Item.Value.Value.setQualifiedNameMatrix( args.Item.Dimensions, args.Item.MatrixValues );
            break;
        default:
            addError( "getMatrixValues: Unknown DataType." );
            break;
