...
CUVariables.NonExclusiveLevel = new Object();
            
CUVariables.NonExclusiveLevel.AlarmType = new UaNodeId( Identifier.NonExclusiveLevelAlarmType );
CUVariables.NonExclusiveLevel.AlarmTypeString = CUVariables.NonExclusiveLevel.AlarmType.toString();
...
if ( !Test.Connect() ) {
    ...
    CUVariables.LimitHelper = new LimitHelper( { 
        AlarmType: CUVariables.NonExclusiveLevel.AlarmType, 
