...
CUVariables.ExclusiveRateOfChange = new Object();
            
CUVariables.ExclusiveRateOfChange.AlarmType = new UaNodeId( Identifier.ExclusiveRateOfChangeAlarmType );
CUVariables.ExclusiveRateOfChange.AlarmTypeString = CUVariables.ExclusiveRateOfChange.AlarmType.toString();
...
if ( !Test.Connect() ) {
    ...
    CUVariables.LimitHelper = new LimitHelper( { 
        AlarmType: CUVariables.ExclusiveRateOfChange.AlarmType, 
