/*  Test prepared by Ing.-Büro Allmendinger; compliance@opcfoundation.org
    Description: Connect using a trusted client certificate. */

function certificateValidation048() {
    ...
    Test.Connect( {
        OpenSecureChannel: {
            ...
            ClientCertificate: Settings.Advanced.Certificates.ApplicationInstanceCertificates.ctt_appT,
            ClientCertificatePrivateKey: Settings.Advanced.Certificates.ApplicationInstanceCertificates.ctt_appTPrivateKey,
...
Test.Execute({ Procedure: certificateValidation048 })