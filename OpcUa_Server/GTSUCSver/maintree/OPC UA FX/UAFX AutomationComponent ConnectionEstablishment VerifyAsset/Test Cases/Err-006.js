/*  Test prepared by Ingenieurbuero Allmendinger: info@allmendinger.de
    Description: Verify EstablishConnections Method behavior when verification variables
                 with invalid BrowseNames are provided.
         ...
         Step 3: Change the BrowseName of any verification variable to Null. Use the unmodified
                 variable values and the modified variable to construct the AssetVerifications
                 argument. Set VerificationMode to AssetCompatibility.
...
function Test_Err_006() {
    ...
    for( var i=0; i < CU_Variables.AllTopLevelAssets.length; i++ ) {
        ...
        //         variable values and the modified variable to construct the AssetVerifications
        //         argument. Set VerificationMode to AssetCompatibility.
        TC_Variables.ExpectedVerificationVariables.result[0].Key = new UaQualifiedName();
