/*  Test prepared by Ingenieurbuero Allmendinger: info@allmendinger.de
    Description : Verify EstablishConnections Method behavior when VerificationMode IdentityAndCompatibility
                  is requested but not supported.
    Requirements: VerificationMode IdentyAndCompatibility is not supported
          ...
          Step 3: Use the variable values to construct the AssetVerifications argument. Set
                  VerificationMode to AssetIdentityAndCompatibility.
...
function Test_Err_011() {
    ...
    for( var i=0; i < CU_Variables.AllTopLevelAssets.length; i++ ) {
        ...
        var callResult = callEstablishConnectionsMethod_VerifyAssetCmd( { 
            ...
            VerificationMode: AssetVerificationMode.AssetIdentityAndCompatibility,
