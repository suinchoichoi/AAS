/*  Test prepared by Ingenieurbuero Allmendinger: info@allmendinger.de
    Description: Verify behavior of EstablishConnections if the VerificationMode is AssetCompatibility
         ...
         Step 3: Select any ExpectedVerificationVariable (only one) and modify the value
                 such that the expected verification result is Mismatch. Use the modified
                 variable value to construct the AssetVerifications argument. Set the VerificationMode
...
Test.Execute( { Procedure: Test_Err_023 } );