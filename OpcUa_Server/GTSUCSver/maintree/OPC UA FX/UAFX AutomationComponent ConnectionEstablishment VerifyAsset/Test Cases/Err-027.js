/*  Test prepared by Ingenieurbuero Allmendinger: info@allmendinger.de
    Description: Verify behavior of EstablishConnections if the VerificationMode is AssetIdentity
                 ...
                 is MATCH. Whereas the verification result for the provided additional
                 verification variables is MISMATCH.
         Step 1: Browse any Asset in the Asset folder.
         Step 2: Read the mandatory and any present optional verification variable of VerificationMode
                 AssetIdentity.
         Step 3: Read any present variable from the selected Asset (shall not be an ExpectedVerificationVariable).
         Step 4: Modify the value from the additional verificiation variable such that the
                 expected verification result is Mismatch. Use the modified additional
                 verification variable and the unmodified verification variables to construct
                 the AssetVerifications argument. Set the VerificationMode to AssetIdentity.
         Step 5: Call EstablishConnections method with the CommandMask set to VerifyAssetCmd.
                 All other command bits are not set.
*/

function Test_Err_027() {
    ...
    for( var i=0; i < CU_Variables.AllTopLevelAssets.length; i++ ) {
        ...
        // Step 2: Read the mandatory and any present optional verification variable
        //         of VerificationMode AssetIdentity.
...
Test.Execute( { Procedure: Test_Err_027 } );