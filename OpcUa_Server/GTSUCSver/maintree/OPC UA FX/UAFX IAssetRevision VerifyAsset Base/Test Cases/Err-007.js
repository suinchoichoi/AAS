/*  Test prepared by Ingenieurbuero Allmendinger: info@allmendinger.de
    Description: Call the VerifyAsset Method and provide a verification variable for
                 verification mode AssetCompatibility with a wrong data type.
         ...
         Step 3: Read all supported verification variables for verification mode AssetCompatibility.
                 Change the data type of the value of any mandatory verification variable.
                 Use the modified variable value to construct the input argument for the method call
                 in Step 4.
         Step 4: Call VerifyAsset method and provide the modified verification variables from the previous step. 
...
function test() {
    ...
    for( var a=0; a<CU_Variables.AllTopLevelAssets.length; a++ ) {
        ...
        // Step 5: Repeat previous steps for any supported verification variable of the selected top level Asset.
        for( var v=0; v<4; v++ ) { // the first 4 values are mandatory variables
            // Modify one of the mandatory ExpectedVerificationVariables
            var originalValue = TC_Variables.ExpectedVerificationVariables.result[v].Value.clone();
            // set value to invalid type (no mandatory expected variable is of type NodeId)
            ...
            // Step 4: Call VerifyAsset method and provide the modified verification variables from
            //         the previous step.
