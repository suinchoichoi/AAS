/*  Test prepared by Ingenieurbuero Allmendinger: info@allmendinger.de
    Description : Verify EstablishConnections behavior when the requested ConnectionEndpointTypeId
                  does not match a concrete subtype of ConnectionEndpointType.
    Requirements: - If CommandBundledRequired is set this becomes a manual test
          ...
          Step 1: Use the Connection information of any ConnectionEndpoint to construct the
                  ConnectionEndpointConfigurations argument. Provide the well-known NodeId
                  of the ConnectionEndpointType (abstract) as ConnectionEndpointTypeId.
...
function Test_Err_008() {
    ...
    var callResult = callEstablishConnectionsMethod_CreateConnectionEndpointCmd( {
        ...
        Name: "AutomationComponent_ConnectionEstablishment_CreateConnectionEndpoint_Err-008",
