/*  Test prepared by Ingenieurbuero Allmendinger: info@allmendinger.de
    Description : Verify EstablishConnections behavior when an element of OutputVariableIds
                  is not referenced from an output folder in either the FunctionalEntity
...
function Test_Err_006() {
    ...
    dynEP_PubSub1.OutputVariableIds[0] = new UaNodeId( Identifier.Server_Auditing );
    ...
    var callResult = callEstablishConnectionsMethod_CreateConnectionEndpointCmd( {
        ...
        Name: "AutomationComponent_ConnectionEstablishment_CreateConnectionEndpoint_Err-006",
