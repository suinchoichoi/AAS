/*  Test 5.10.2 Test 20, prepared by Nathan Pocock; compliance@opcfoundation.org
    Description:
          Create two subscriptions with their priorities being equal. Modify the first subscriptions to have a HIGHER priority.
          Write some values and call Publish(). Then lower the first subscriptions' priority to have the least priority.
