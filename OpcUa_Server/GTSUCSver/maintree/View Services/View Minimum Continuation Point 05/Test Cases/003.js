...
function TestBrowseNextOnMultipleNodes() {
    ...
    if( maxNodesPerBrowse != 0 && maxNodesPerBrowse < 5 ) {
        addSkipped( "Servers MaxNodesPerBrowse must be at least 5 to run this test. MaxNodesPerBrowse: " + maxNodesPerBrowse );
        return( false );
    }
    var nodeIdsToBrowse = [
