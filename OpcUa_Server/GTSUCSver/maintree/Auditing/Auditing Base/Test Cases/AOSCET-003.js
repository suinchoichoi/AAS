/*  Test prepared by Ing.-Buero Allmendinger: info@allmendinger.de
    Description:    Client calls OpenSecureChannel, sends an invalid certificate.
    Expectation:    An audit event is created for the failed connection.
*/

function auditingBaseAOSCET003() {
    ...
    tc.setByteString( cu_LoadCertificate( Settings.Advanced.Certificates.ApplicationInstanceCertificates.ctt_appTSincorrect, tc_pkiProvider ) );
...
Test.Execute( { Procedure: auditingBaseAOSCET003 } );
