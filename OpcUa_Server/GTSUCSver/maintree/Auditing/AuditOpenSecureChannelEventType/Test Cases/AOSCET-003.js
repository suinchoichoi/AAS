/*  Test prepared by Nathan Pocock: compliance@opcfoundation.org
    Description: OpenSecureChannel (secure) with invalid certificate; check if audit event AuditOpenSecureChannelEventType received */
...
function testx() {
    ...
    if( channel2.Execute(  {
                            ...
                            ClientCertificate: readSetting( "/Advanced/Certificates/ApplicationInstanceCertificates/ctt_appTSincorrect" ).toString(),
                            ClientCertificatePrivateKey: readSetting( "/Advanced/Certificates/ApplicationInstanceCertificates/ctt_appTSincorrectPrivateKey" ).toString(),
                            ServiceResult: new ExpectedAndAcceptedResults( [ StatusCode.BadSecurityChecksFailed, StatusCode.BadSecurityPolicyRejected ] ) } ) ) {
