/*  Test prepared by Nathan Pocock: compliance@opcfoundation.org
    Description: OpenSecureChannel (secure) with no certificate; check if audit event AuditOpenSecureChannelEventType received */
...
function testx() {
    ...
    if( channel2.Execute(  { 
                            RequestedSecurityPolicyUri:  SecurityPolicy.policyFromString( epSecureSign.SecurityPolicyUri ),
                            MessageSecurityMode:         epSecureSign.SecurityMode,
                            ...
                            PreHook:                     clearClientCertificate } ) ) {
