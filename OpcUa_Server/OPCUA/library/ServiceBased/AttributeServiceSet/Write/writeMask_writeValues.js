function populateNodesToWriteFromWriteMask( writeRequest, nodeIdString, writeMask )
{
    ...
    if( writeMask & AttributeWriteMask.BrowseName )
    {
        ...
        writeRequest.NodesToWrite[currentNodeNumber].Value.Value = new UaVariant();
        var bn = new UaQualifiedName();
        bn.NamespaceIndex = UaNodeId.fromString( nodeIdString ).NamespaceIndex;
        bn.Name = "Browse_5.8.2-003";
        writeRequest.NodesToWrite[currentNodeNumber].Value.Value.setQualifiedName( bn );
    }
