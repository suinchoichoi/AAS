...
function TestBrowseOneNodeWithResultMask( Session, nodeToBrowse, resultMask, returnDiagnostics  ) {
    ...
    for( var i=0; i<allReferences.length; i++ ) {
        ...
        Assert.NodeIdNotNull( allReferences[i].ReferenceTypeId, referenceText + "ReferenceTypeId is a null NodeId" );
        ...
        Assert.QualifiedNameNotNull( allReferences[i].BrowseName, referenceText + "BrowseName is null or empty" );
