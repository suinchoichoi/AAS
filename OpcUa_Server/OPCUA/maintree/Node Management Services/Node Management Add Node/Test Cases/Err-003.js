    ...
    var parameters = { 
        ...
        NodesToAdd: [
                UaAddNodesItem.New( { 
                        ...
                        ParentNodeId: MonitoredItem.fromSettings( Settings.Advanced.NodeIds.Invalid.Unknowns )[0].NodeId,
        ...
        OperationResults: [ new ExpectedAndAcceptedResults( StatusCode.BadParentNodeIdInvalid ) ] };
