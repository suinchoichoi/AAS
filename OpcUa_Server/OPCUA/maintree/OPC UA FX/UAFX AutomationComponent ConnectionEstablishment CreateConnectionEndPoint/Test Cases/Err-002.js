/*  Test prepared by Ingenieurbuero Allmendinger: info@allmendinger.de
    Description : Verify EstablishConnections behavior when no InputVariableIds and OutputVariableIds
                  were specified.
    Requirements: - Dynamically created ConnectionEndpoints supported
          ...
          Step 1: Use the Connection information of any dynamically created ConnectionEndpoint
                  (prefer connections supporting mode PublisherSubscriber) to construct
                  the ConnectionEndpointConfigurations argument. Set InputVariableIds and
                  OutputVariableIds to empty arrays.
...
function Test_Err_002() {
    ...
    var callResult = callEstablishConnectionsMethod_CreateConnectionEndpointCmd( {
        ...
        Name: "AutomationComponent_ConnectionEstablishment_CreateConnectionEndpoint_Err-002",
