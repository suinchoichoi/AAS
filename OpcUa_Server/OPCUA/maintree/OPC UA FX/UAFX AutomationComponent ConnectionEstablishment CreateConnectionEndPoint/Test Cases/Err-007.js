/*  Test prepared by Ingenieurbuero Allmendinger: info@allmendinger.de
    Description : Verify EstablishConnections behavior when a null RelatedEndpoint was specified.
    Requirements: - If CommandBundledRequired is set this becomes a manual test
          ...
          Step 1: Use the connection information of any ConnectionEndpoint to construct the
                  ConnectionEndpointConfigurations argument. Provide a null as RelatedEndpoint.
...
function Test_Err_007() {
    ...
    var callResult = callEstablishConnectionsMethod_CreateConnectionEndpointCmd( {
        ...
        Name: "AutomationComponent_ConnectionEstablishment_CreateConnectionEndpoint_Err-007",
