/*  Test prepared by Ingenieurbuero Allmendinger: info@allmendinger.de
    Description: Call the Verify Method and provide a valid but unknown NodeId in the key
                 field.
*/
...
function Test_015() {
    ...
    TC_Variables.ExpectedVerificationVariablesErrors_0 = new ExpectedAndAcceptedResults( StatusCode.BadNodeIdUnknown );
    
    TC_Variables.UnknownNodeId = new UaNodeId.fromString( Settings.Advanced.NodeIds.Invalid.Unknown1 );
    addLog( "Unknown NodeId use for this test: " + TC_Variables.UnknownNodeId );
    ...
    if( CU_Variables.AllFunctionalEntities.length > 0 ) {
        for( var i=0; i<CU_Variables.AllFunctionalEntities.length; i++ ) {
            var callResult = callVerifyMethod( {
                ...
                NodeIds: [ TC_Variables.UnknownNodeId ],
