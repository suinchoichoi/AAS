/*  Test prepared by Ingenieurbuero Allmendinger: info@allmendinger.de
    Description: Verify EstablishConnections Method behavior when a verification variable
                 for VerificationMode AssetCompatibility with a wrong data type is provided.
         ...
         Step 3: Change the data type of the value of any mandatory verification variable.
                 Use the modified variable value to construct the AssetVerifications argument.
...
function Test_Err_012() {
    ...
    for( var i=0; i < CU_Variables.AllTopLevelAssets.length; i++ ) {
        ...
        // Step 5: Repeat previous steps for any supported ExpectedVerificationVariable of
        ...
        for( var v=0; v<TC_Variables.ExpectedVerificationVariables.result.length; v++ ) {
            ...
            // Modify the DataType of the ExpectedVerificationVariable
