/*  Test prepared by Ingenieurbuero Allmendinger: info@allmendinger.de
    Description: Call the VerifyAsset Method and provide a verification variable for verification mode AssetIdentity with a wrong data type.
...
function test() {
    ...
    for( var a=0; a<CU_Variables.AllTopLevelAssets.length; a++ ) {
        ...
        // Step 5: Repeat previous steps for any supported verification variable of the selected top level Asset.
        for( var v=0; v<TC_Variables.ExpectedVerificationVariables.result.length; v++ ) { // all variables are mandatory variables
