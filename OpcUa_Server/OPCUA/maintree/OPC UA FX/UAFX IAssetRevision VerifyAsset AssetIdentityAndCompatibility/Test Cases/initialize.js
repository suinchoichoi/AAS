...
CU_Variables.CU_Name = "UAFX IAssetRevision VerifyAsset AssetIdentityAndCompatibility";
...
if( Test.Connect() ) {
    ...
    if( Settings.OPC_UA_FX.VerificationMode_IdentityAndCompatibility_supported ) {
        ...
        addSkipped( "VerificationMode AssetIdentityAndCompatibility is not supported according to the settings. Skipping CU." );
        stopCurrentUnit();
    }
}
