/*  Test prepared Ing.-Büro Allmendinger; info@allmendinger.de
    Description: Activate a session using an issued X509 user certificate that is TRUSTED where the issuer is not available. */

function securityx509_010() {
    ...
    ActivateSessionHelper.Execute( {
        ...
        UserIdentityToken: UaUserIdentityToken.FromUserCredentials( {
            ...
            CertificateSetting: Settings.Advanced.Certificates.X509UserIdentityCertificates.ctt_ca1U_usrT
        } ),
...
Test.Execute( { Procedure: securityx509_010 } );