...
function securityx509_015() {
    ...
    ActivateSessionHelper.Execute( {
        ...
        UserIdentityToken: UaUserIdentityToken.FromUserCredentials( {
            ...
            CertificateSetting: Settings.Advanced.Certificates.X509UserIdentityCertificates.ctt_ca1T_usrUR
        } ),
...
Test.Execute({ Procedure: securityx509_015 });