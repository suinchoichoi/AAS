/*  Test prepared by Ing.-Büro Allmendinger; compliance@opcfoundation.org
    Description: Connect using an (trusted) issued certificate of a CA that has no revocation list available. */

function certificateValidation042() {
    ...
    Test.Connect( {
        OpenSecureChannel: {
            ...
            ClientCertificate: Settings.Advanced.Certificates.ApplicationInstanceCertificates.ctt_ca1TC_appT,
            ClientCertificatePrivateKey: Settings.Advanced.Certificates.ApplicationInstanceCertificates.ctt_ca1TC_appTPrivateKey,
...
Test.Execute( { Procedure: certificateValidation042 } );
