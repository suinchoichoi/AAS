const CU_NAME = "Security Basic 256Rsa256";
...
const SECURITY_POLICYURI_BASIC256SHA256 = "http://opcfoundation.org/UA/SecurityPolicy#Basic256Sha256"
...
for (var e = 0; e < gServerCapabilities.Endpoints.length; e++) {
    ...
    if (ep.SecurityPolicyUri === SECURITY_POLICYURI_BASIC256SHA256) {
...
if (epSecureEncrypt === null && epSecureSign === null) {
    addSkipped("Secure endpoint using BASIC256SHA256 not found!");
    stopCurrentUnit();
}
else {
