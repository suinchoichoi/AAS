...
CUVariables.NonExclusiveRateOfChange = new Object();
            
CUVariables.NonExclusiveRateOfChange.AlarmType = new UaNodeId( Identifier.NonExclusiveRateOfChangeAlarmType );
CUVariables.NonExclusiveRateOfChange.AlarmTypeString = CUVariables.NonExclusiveRateOfChange.AlarmType.toString();
...
if ( !Test.Connect() ) {
    ...
    CUVariables.LimitHelper = new LimitHelper( { 
        AlarmType: CUVariables.NonExclusiveRateOfChange.AlarmType, 
