...
CUVariables.ExclusiveLimit = new Object();
            
CUVariables.ExclusiveLimit.AlarmType = new UaNodeId( Identifier.ExclusiveLimitAlarmType );
CUVariables.ExclusiveLimit.AlarmTypeString = CUVariables.ExclusiveLimit.AlarmType.toString();
...
if ( !Test.Connect() ) {
    ...
    CUVariables.LimitHelper = new LimitHelper( { 
        AlarmType: CUVariables.ExclusiveLimit.AlarmType, 
