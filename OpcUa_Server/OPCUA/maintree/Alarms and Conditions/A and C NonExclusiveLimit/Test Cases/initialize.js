...
CUVariables.NonExclusiveLimit = new Object();

CUVariables.NonExclusiveLimit.AlarmType = new UaNodeId( Identifier.NonExclusiveLimitAlarmType );
CUVariables.NonExclusiveLimit.AlarmTypeString = CUVariables.NonExclusiveLimit.AlarmType.toString();
...
if ( !Test.Connect() ) {
    ...
    CUVariables.LimitHelper = new LimitHelper( { 
        AlarmType: CUVariables.NonExclusiveLimit.AlarmType, 
