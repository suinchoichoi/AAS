/*
    ...
    Description:  
        ...
        3.) The alarm transition to a different state (still alarmed)

    Requirements:
        an alarm that transition between HI and HIHI repeatedly, but stays active
    ...
    Expectation:
        ...
        3.) Event received and property ShelvingState=OneShotShelved and LastTransition was from Unshelved to OneShotShelved.  
            The SuppressedOrShelved property is TRUE
*/
        ...
        if ( localTestCase.State == this.States.Initial ) {
            ...
            if ( isActive ) {
                if ( CUVariables.Shelve.ValidateShelveStates( eventFields,
                    collector, localTestCase, CUVariables.Shelve.OneShotShelved, true ) ) {
