...
function browse571Err8() {
    ...
    if (ReadHelper.Execute({
        ...
        MaxNodesPerBrowseValue = -1;
    }
    if ( MaxNodesPerBrowseValue > continuationPointsToTry || MaxNodesPerBrowseValue == 0 ) {
        ...
        addLog("Couldn't verify correct StatusCode when exceeding the MaxNodesPerBrowseValue as MaxNodesPerBrowse is smaller than MaxBrowseContinuationPoints.");
    }
    return( true );
}
