/*  Test prepared by Nathan Pocock; compliance@opcfoundation.org
    Description: Create a MonitoredItem using a ByteStringArray while specifying invalid IndexRange as being outside of the bounds of the array.
...
function createMonitoredItems591Err028() {
    ...
    if( iByteString == null ) {
        addSkipped( "ByteString Array nodeId is not configured in Static > AllProfiles > Arrays. Skipping test." );
        return( false );
    }
    var monitoredItems = MonitoredItem.fromNodeIds( [ iByteString ], 
