...
function publishCallback( response, callbackData ) {
    ...
    if( response.NotificationMessage.NotificationData.size > 0 ) {
        ...
        if( dataChangeEvent !== undefined && dataChangeEvent !== null ) print( "Publish callback: Received DataChangeNotification with " + dataChangeEvent.MonitoredItems.length + " Elements." );
    }
